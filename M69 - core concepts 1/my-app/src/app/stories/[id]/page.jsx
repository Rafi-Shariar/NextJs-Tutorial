   ...
   return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center text-sm font-medium text-gray-600 hover:text-blue-600 mb-6 transition-colors"
        >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          {/* Cover Accent Banner (Facebook style) */}
          <div className="h-32 bg-gradient-to-r stream bg-blue-600 to-indigo-700"></div>

          {/* Profile Header Area */}
          <div className="px-6 pb-6 relative flex flex-col sm:flex-row sm:items-end sm:space-x-5 -mt-16">
            ...
            <div className="mt-6 sm:mt-0 flex-1">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 tracking-tight">{story.name}</h1>
                  <p className="text-lg font-medium text-gray-600 mt-1">
                    {story.designation} at <span className="text-indigo-600 font-semibold">{story.company}</span>
                  </p>
                </div>
                <span className="bg-indigo-50 text-indigo-700 text-sm font-bold px-4 py-1.5 rounded-full border border-indigo-100">
                  {story.experience} Years Experience
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1 space-y-6">
              ...
              {/* Skills Section */}
              <div>
                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">Core Stack</h3>
                <div className="flex flex-wrap gap-2">
                  {story.skills.map((skill, index) => (
                    <span
                      key={index}
                      className="bg-gray-100 text-gray-800 text-xs font-semibold px-3 py-1.5 rounded-lg border border-gray-200"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            {/* Right Column: The Full Story */}
            <div className="md:col-span-2">
              <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">My Dev Journey</h3>
              <div className="bg-indigo-50/30 rounded-2xl p-6 border border-indigo-100/50">
                {/* Large quote icon styling */}
                <span className="text-4xl text-indigo-200 font-serif block -mb-2 leading-none">“</span>
                <p className="text-gray-800 text-[16px] leading-relaxed font-normal whitespace-pre-line text-justify">
                  {story.story}
                </p>
                <span className="text-4xl text-indigo-200 font-serif block text-right -mt-4 leading-none">”</span>
              </div>
            </div>
